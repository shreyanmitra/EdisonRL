// EdisonRL Grid Builder — local inline SVG icons
// Replaces CDN-loaded Lucide font icons to avoid tracking-prevention blocks.

var ICON_SVGS = {
  "layers": '<path d="M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.84Z"/><path d="m22 12.5-8.58 3.91a2 2 0 0 1-1.66 0L2 12.5"/><path d="m22 17-8.58 3.91a2 2 0 0 1-1.66 0L2 17"/>',
  ...
  "ruler": '<path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/><path d="m15 5 4 4"/>',
...
(function () {
  ...
  window._iconSvg = function (name) {
    return '<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' + (ICON_SVGS[name] || "") + "</svg>";
  };
})();
